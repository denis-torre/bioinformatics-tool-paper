...
# Altmetric API URL
altmetric_url = 'https://api.altmetric.com/v1/doi/'+str(doi).replace('https://doi.org/', '')
...
try:
    ...
    # Return empty dict
    metrics_data = {'doi': str(doi), 'attention_score': None, 'altmetric_badge':None, 'attention_percentile': None, 'citations': None}
